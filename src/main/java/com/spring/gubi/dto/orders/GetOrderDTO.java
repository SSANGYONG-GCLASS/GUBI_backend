...
public class GetOrderDTO {
    ...
    // 배송지
    private GetOrderDeliveryDTO delivery;
    ...
    public GetOrderDTO(Order order) {
        ...
        this.delivery = new GetOrderDeliveryDTO(order.getDelivery());

        this.orderDetails = order.getOrderDetails().stream().map(GetOrderDetailDTO::new).collect(Collectors.toList());
    }
}
